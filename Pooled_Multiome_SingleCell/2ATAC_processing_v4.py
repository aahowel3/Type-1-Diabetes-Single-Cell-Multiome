...
def convert_10X_bam(args):
    ...
    print('[[Py window script]]:Converting the bam file:',datetime.now())
...
def remove_duplicate_reads(args):
    ...
    print('[[Py window script]]: Removing duplicate reads:',datetime.now())
    ...
    rmdup_cmd = ['samtools', 'view', '-@', str(args.threads), '-b', '-f', '3', '-F', '1024', markdup_bam] #filter bams for those mapped with pair, no PCR duplicates
...
def create_tagAlign(args):
    ...
    print('[[Py window script]]: Creating the tagAlign file:',datetime.now())
...
def create_ATAC_windows_lfm(args):
    ...
    print("[[Py window script]]: Creating the filtered fragment file:",datetime.now())
    ...
    print("[[Py window script]]: Creating the filtered bed file:",datetime.now())
    ...
    print("[[Py window script]]: Sorting the filtered bed file:",datetime.now())
    ...
    print("[[Py window script]]: Creating the windows LFM:",datetime.now())
...
def main(args):
    ...
    print("[[Py window script]]: Done:",datetime.now())
    return
